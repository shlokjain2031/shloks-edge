...
const work: WorkItem[] = [
  {
    ...
    description:
      'Owned the infra, harness and data layers agents ran on (~500k req/day), and also the manual workflow automations, one of which cut time to quote a policy from 1 day to 5s. Did sales.',
